...
buildscript {
    ...
    dependencies {
        classpath 'com.lge.android.license:dependency-scanning-tool:0.3.0'
    }
}
...
1	build.gralde	android.arch.core:common	1.1.1	The Apache Software License, Version 2.0	https://mvnrepository.com/artifact/android.arch.core/common/1.1.1	https://developer.android.com/topic/libraries/architecture/index.html		http://www.apache.org/licenses/LICENSE-2.0.txt
2	build.gralde	om.google.code.findbugs:jsr305	3.0.1	The Apache Software License, Version 2.0	https://mvnrepository.com/artifact/com.google.code.findbugs/jsr305/3.0.1	http://findbugs.sourceforge.net/		http://www.apache.org/licenses/LICENSE-2.0.txt
```
